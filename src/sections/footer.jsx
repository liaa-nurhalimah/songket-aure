...
export default function Footer() {
  return (
   <footer className="bg-yellow-950 text-white py-8 flex flex-col items-center text-center">
      {/* Navigation Links */}
        ...
        <a href="#" aria-label="Twitter">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="fill-current">
           <path d="M24 4.557c-.883.392-1.832.656-2.828.775
             ...
             -2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07
             1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212
             7.548 2.212 9.142 0 14.307-7.721 13.995-14.646
        ...
        <a href="#" aria-label="YouTube">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" className="fill-current">
           <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23
             ...
             15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029
             -6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8
             3.993-8 4.007z"/>
          </svg>
        </a>
      ...
      <div className="flex items-center gap-2 text-sm">
        ...
        <p>Copyright ©️ 2025 - All rights reserved by Songket Aurè</p>
      </div>
    </footer>
  );
}